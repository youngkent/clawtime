...
const DATA_DIR =
  process.env.CLAWTIME_DATA_DIR ||
  process.env.CLAWTIME_DATA ||
  path.join(os.homedir(), ".clawtime");
...
export function getActiveClientWs() {
  return activeClientWs;
}
export function setActiveClientWs(ws) {
  activeClientWs = ws;
}

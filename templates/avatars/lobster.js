...
(function () {
  ...
  function animate() {
    ...
    if (currentState !== "working" && currentState !== "coding") {
      ...
      if (window._leftArm) {
        window._leftArm.position.set(-1.6, 2.8, 0.3);
        window._leftArm.rotation.z = 0.4;
        window._leftArm.rotation.x = 0;
      }
      if (window._rightArm) {
        window._rightArm.position.set(1.6, 2.8, 0.3);
        window._rightArm.rotation.z = -0.4;
        window._rightArm.rotation.x = 0;
      }
    }
    ...
    // Reset antennae
    if (leftAntenna) {
      leftAntenna.rotation.x = 0;
      leftAntenna.rotation.z = 0.3;
    }
    if (rightAntenna) {
      rightAntenna.rotation.x = 0;
    ...
    if (currentState === "idle") {
      ...
      if (leftPupil) {
        leftPupil.position.y = 5.85;
        leftPupil.position.z = 0.65;
      }
      if (rightPupil) {
        rightPupil.position.y = 5.85;
        rightPupil.position.z = 0.65;
      }

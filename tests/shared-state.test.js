...
describe('Shared State', () => {
  ...
  describe('Broadcast', () => {
    ...
    test('should skip closed clients', () => {
      ...
      const client2 = { id: 'c2', readyState: 3, _secureSend: () => { client2Called = true; } }; // CLOSED
      sharedClients.add(client1);
      sharedClients.add(client2);
  ...
  describe('Skip Conditions', () => {
    ...
    test('should skip non-bot messages', () => {
      ...
      const isBot = payload.message?.role === 'assistant' || payload.state === 'delta' || payload.state === 'final';
...
describe('User Message Sync', () => {
  test('should broadcast user message to other clients', () => {
    ...
    const receiver = { id: 'receiver', messages: [], _secureSend: function(d) { this.messages.push(JSON.parse(d)); } };

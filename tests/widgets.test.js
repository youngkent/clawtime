...
describe("Widget System", () => {
  describe("Widget Extraction", () => {
    test("should extract single widget from text", () => {
      const text =
        'Some text [[WIDGET:{"widget":"buttons","id":"test-1","prompt":"Choose","buttons":[{"label":"A","value":"a"}]}]] more text';
    ...
    test("should extract multiple widgets", () => {
      const text =
        '[[WIDGET:{"widget":"buttons","id":"w1","buttons":[]}]] text [[WIDGET:{"widget":"confirm","id":"w2"}]]';
      const result = extractWidgets(text);
